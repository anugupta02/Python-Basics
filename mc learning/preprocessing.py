...
def main():
    ...
    f = open(os.path.join(path, 'C:\\Users\\anugu\\Desktop\\Anu Study\\Python Notes\\mc learning\\scrapped_headlines.txt'), 'rt', encoding='utf-8')
    ...
    with open(os.path.join(path, 'C:\\Users\\anugu\\Desktop\\Anu Study\\Python Notes\\mc learning\\headlines_cleaned.txt'), 'w') as fw:
